      ...
      <div class="credit-card-info--form">
        <div class="input_container">
          ...
          <input id="password_field" class="input_field" type="text" name="input-name" title="Inpit title"
            placeholder="Entrez le nom entier">
        </div>
        <div class="input_container">
          <label for="password_field" class="input_label">Numéro de la carte</label>
          <input id="password_field" class="input_field" type="number" name="input-name" title="Inpit title"
            placeholder="0000 0000 0000 0000">
        </div>
        <div class="input_container">
          <label for="password_field" class="input_label">Date d'expiration / CVV</label>
          <div class="split">
...
const simulatePaymentSuccess = () => {
  emits('payment-successful', true);  // Simuler le succès du paiement
};
</script>
